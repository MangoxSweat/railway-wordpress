...
$string_array = array(
	...
	'enter_number_of_days' => esc_html__( 'Please Enter Number of Days', 'service-finder' ),
	'make_featured' => esc_html__( 'Make Featured', 'service-finder' ),
	'enter_amount' => esc_html__( 'Please Enter Amount', 'service-finder' ),
	'amount_for_featured' => esc_html__( 'Amount for Featured', 'service-finder' ),
	'approve' => esc_html__( 'Approve', 'service-finder' ),
	'make_featured' => esc_html__( 'Make Featured', 'service-finder' ),
	'update' => esc_html__( 'Update', 'service-finder' ),
	'sure_to_update' => esc_html__( 'Are you sure you want to approve?', 'service-finder' )
);
