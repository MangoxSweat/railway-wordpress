 ...
 */
 ...
 h2 {<?php 
 	...
 	echo (service_finder_theme_get_data($data['h2-size'],'text-transform') != '') ? 'text-transform:'.service_finder_theme_get_data($data['h2-size'],'text-transform').'; '  : '';
 	 ?>} 
.wp-block-search .wp-block-search__label {<?php 
 	echo (service_finder_theme_get_data($data['h2-size'],'font-family') != '') ? 'font-family:'.service_finder_theme_get_data($data['h2-size'],'font-family').'; ' : '';
 	echo (service_finder_theme_get_data($data['h2-size'],'font-weight') != '') ? 'font-weight:'.service_finder_theme_get_data($data['h2-size'],'font-weight').'; ' : '';
 	echo (service_finder_theme_get_data($data['h2-size'],'line-height') != '') ? 'line-height:'.service_finder_theme_get_data($data['h2-size'],'line-height').'; ' : '';
 	echo (service_finder_theme_get_data($data['h2-size'],'color') != '') ? 'color:'.service_finder_theme_get_data($data['h2-size'],'color').'; ' : '';
...
.sf-findBar-vertical .sf-advace-search-two .tooltip .tooltip-inner { <?php echo (service_finder_theme_get_data($data,'color-scheme') != '') ? 'background:'.service_finder_theme_get_data($data,'color-scheme').'; ' : 'background: #ffb600'; ?>; }
.sf-findBar-vertical .sf-advace-search-two .tooltip.top .tooltip-arrow {  <?php echo (service_finder_theme_get_data($data,'color-scheme') != '') ? 'border-top-color:'.service_finder_theme_get_data($data,'color-scheme').'; ' : 'border-top-color: #ffb600'; ?>; }
.bootbox.modal {
  z-index: 9999;
}
...
.media-bg-animate:hover:before {
 <?php echo (service_finder_theme_get_data($data,'color-scheme') != '') ? 'background-color:'.service_finder_theme_get_data($data,'color-scheme').'; ' : ''; ?>
  animation: 1s clockwise infinite;
}
.media-bg-animate:hover:after {
 <?php echo (service_finder_theme_get_data($data,'seconday-color-scheme') != '') ? 'background-color:'.service_finder_theme_get_data($data,'seconday-color-scheme').'; ' : ''; ?>
...
body .aon-blog-style-1 .post-bx {  <?php echo (service_finder_theme_get_data($data,'color-scheme') != '') ? 'border-color:'.service_finder_theme_get_data($data,'color-scheme').'; ' : ''; ?> border-bottom-style::solid;  border-bottom-width:3px; }
body .aon-post-jobs2 {border-color:#ddd;  <?php echo (service_finder_theme_get_data($data,'color-scheme') != '') ? 'border-color:'.service_finder_theme_get_data($data,'color-scheme').'; ' : ''; ?> border-left-style::solid;  border-left-width:3px;}
...
.aon-all-cat-block .aon-cat-quantity span {  box-shadow: 7px 7px <?php echo (service_finder_theme_get_data($data,'color-scheme') != '') ? service_finder_theme_get_data($data,'color-scheme').'; ' : ''; ?> }

.aon-all-cat-block .aon-cat-name a { box-shadow:4px 0px <?php echo (service_finder_theme_get_data($data,'seconday-color-scheme') != '') ? service_finder_theme_get_data($data,'seconday-color-scheme').'; ' : ''; ?> }


.aon-bnr2-media-wrap .circle-l-2,
.aon-bnr2-media-wrap .circle-r-2,
.aon-bnr2-media-wrap .aon-bnr2-media::before  {  background-color:<?php echo (service_finder_theme_get_data($data,'seconday-color-scheme') != '') ? service_finder_theme_get_data($data,'seconday-color-scheme').'; ' : ''; ?>; }
...
.aon-bnr2-media-wrap .aon-bnr2-media::after {  background-color:<?php echo (service_finder_theme_get_data($data,'color-scheme') != '') ? service_finder_theme_get_data($data,'color-scheme').'; ' : ''; ?>; }
